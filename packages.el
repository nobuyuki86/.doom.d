...
(package! company-dwim :recipe (:host github :repo "zk-phi/company-dwim"))
(package! company-anywhere :recipe (:host github :repo "zk-phi/company-anywhere"))
(package! company-prescient)
(package! copilot :recipe (:host github :repo "zerolfx/copilot.el" :files ("*.el" "dist")))
(package! lsp-pyright)
(package! zonokai-theme)
(package! nyan-mode)
